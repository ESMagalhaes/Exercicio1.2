...
public class Ex2viewer {
	...
	public static void main(String[] args) {
		Exercicio2 ex2 = new Exercicio2(); // chamada para os métodos da classe Exercicio2.java
		...
		JOptionPane.showMessageDialog(null, "o menor valor no vetor é: " + lessValor);	// final (encontrado a partir do tamanho menos 1),
																						// tamanho, e o valor no índice
